    ...
    <div className="app" ref={appRef}>
      <header className="header">
        ...
        <div className="header-info">
          <span className="header-name">Fin</span>
          <span className="header-status">Assistente Financeiro IA</span>
        </div>
      </header>
        ...
        <div className="dash-logo">
          <img
            ...
            onError={e => {
              ...
              e.target.parentNode.insertAdjacentHTML('afterbegin', '<span class="dash-logo-oren">Oren</span><span class="dash-logo-ia">IA</span>');
            }}
          />
